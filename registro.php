...
if (window.screen){
	if (window.screen.width > 800){
		...
		top.document.location.replace("http://www.frigorificosarria.com/registrob.php");
		//top.document.location.replace("http://ricardo/sarria/registrob.php");
	}
}
</script>
...
<p></p></td>
  ...
  <tr><!-- row 3 -->
   <td><img name="quienessomos_r3_c1" src="Imagenes/QuienesSomos/quienessomos_r3_c1.jpg" width="106" height="270" border="0" usemap="#m_quienessomos_r3_c1" alt=""></td>
    <td colspan="5" valign="top" bgcolor="#FFFFFF"><div align="center"><strong><font color="#990000" size="3" face="Verdana, Arial, Helvetica, sans-serif"><u><br>
	...
	?>
        ...
        <table width="54%" border="0" align="center">
          <tr> 
            <td height="38" nowrap><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Raz&oacute;n 
			...
			?>
            <td><input name="razonsocial" type="text" id="razonsocial3" class="unnamed1" size="35"></td>
            <?
			}
			?>
          </tr>
